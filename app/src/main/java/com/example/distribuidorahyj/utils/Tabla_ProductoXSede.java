...
public class Tabla_ProductoXSede {
    ...
    public static final String CREAR_TABLA_PRODUCTOXSEDE = "CREATE TABLE " + TABLA_PRODUCTOXSEDE + " (" + CAMPO_CODIGOPRODUCTO + " INTEGER primary key AUTOIMCREMENTABLE, " + CAMPO_CODIGOSEDE + " STRING, " + CAMPO_ACTIVO + " STRING)";
